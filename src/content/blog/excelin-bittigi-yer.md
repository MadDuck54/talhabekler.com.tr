...
Sistem gelmeden önce fabrikada üç araç paralel çalışıyordu. Satış ekibi siparişleri ve raporları **Excel** dosyalarında tutardı. **Kağıt formlar** sipariş bildirimi, imalat raporu ve sevkiyat kağıdı için kullanılırdı — imalat ekibi imalat raporunu, sevkiyat ekibi sevkiyat kağıdını doldururdu. Birimler arası iletişim ise **WhatsApp** üzerinden, gruplarda akardı.
...
Yani: planda var ama yazılmamış. İş emri çıkana kadar olan kısım sistematik, ondan sonrası — üretim, ebatlama, sevkiyat, stok, lot izleme, etiket — sahada hâlâ Excel + WhatsApp + kağıttı.
